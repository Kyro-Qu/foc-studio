...
const STRINGS = {
  zh: {
    ...
    "panel.scope.title": "实时示波器 — JustFloat 16 通道 · 点击设 t1/t2 · Shift/Alt 微调 · 滚轮缩放",
    ...
    "sys.boot": "FOC Studio v0.3.1 — 示波器/图例 · 调参 · 控制台 · 录制",
  ...
  en: {
    ...
    "panel.scope.title": "Real-time scope — JustFloat 16ch · click t1/t2 · Shift/Alt · wheel zoom",
    ...
    "sys.boot": "FOC Studio v0.3.1 — Scope/Legend · Tuning · Console · Record",
