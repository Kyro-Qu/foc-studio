...
const STRINGS = {
  zh: {
    ...
    "wf.wait": "等待命令…",
    "wf.needs_fw": "待固件",
    "wf.device.h": "1. 连接与板卡信息",
    "wf.device.p": "连接串口后读取固件版本、状态、是否打开遥测。",
    ...
    "wf.motor.h": "3. 电机参数",
    "wf.motor.p": "极对数、配置读写；Rs/Ls 用「校准」页辨识。",
    "wf.motor.pp": "极对数",
  ...
  en: {
    ...
    "wf.device.h": "1. Connect & board info",
    "wf.device.p": "Connect serial, read firmware version and status.",
    ...
    "wf.safety.h": "2. Safety & protection",
    ...
    "wf.motor.h": "3. Motor params",
    "wf.motor.p": "Pole pairs and config. Rs/Ls on Calib page.",
